...
def get_config():
    ...
    config.data.fid_stats = ['assets/stats/imagenet.zip']
    config.data.path = 'data/processed/imagenet.zip'
    ...
    config.diffusion_model.num_classes = 1000
    config.diffusion_model.fourier_scale = 16
    config.diffusion_model.pred = 'eps'
    config.diffusion_model.M = 1.
    config.diffusion_model.ckpt_path = 'work_dir/imagenet/cond_checkpoint_400000.pth'
