...
def sample_and_test(args):
    ...
    ckpt = torch.load('./saved_info/latent_flow_inpaint/{}/{}/model_{}.pth'.format(args.dataset, args.exp, args.epoch_id), map_location=device)
    ...
    for i , (image, mask, masked_image) in enumerate(dataloader):
        ...
        with torch.no_grad():
            ...
            for j, x in enumerate(fake_image):
                ...
                torchvision.utils.save_image(x, './inpainting_generated_samples/{}/{}.jpg'.format(args.dataset, index), normalized=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_size', type=int, default=256,
                            help='size of image')
    parser.add_argument('--num_in_channels', type=int, default=9,
