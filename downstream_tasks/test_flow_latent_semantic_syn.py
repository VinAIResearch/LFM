...
import torchvision
from datasets_prep.ade20k import ADE20kValidation
from datasets_prep.celeb_mask import CelebAMaskValidation
        ...
        with torch.no_grad():
            ...
            for j, x in enumerate(fake_image):
                ...
                torchvision.utils.save_image(
                    x,
                    "./mask2image_generated_samples/{}/{}.jpg".format(args.dataset, index),
                    normalized=True,
                )
